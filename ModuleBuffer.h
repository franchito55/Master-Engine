...
public:
	...
	static void createDefaultBuffer(ComPtr<ID3D12Resource>& resourceHandle, D3D12_RESOURCE_DESC& bufferDesc);
	static void copyDataToBuffer(ComPtr<ID3D12Resource>& resourceHandle, const void* data, const size_t size);
private:
	HWND hWnd;
};